...
// {{{ --------------------------properties-------------------------------------
    ...
    /**
     * Indicates whether the last row in the grid is clipped and thus not fully display.
     ...
     * needed for deciding whether the user scrolls up or down.
     * @param {Number}
     */
    lastIndex : -1,
...
// {{{ ----------------------dom/mouse listeners--------------------------------
     ...
     * and the number of visible rows whether the horizontal scrollbar is shown
     * or not.
     */
     ...
     * height and the number of visible rows whether the horizontal scrollbar is shown
     * or not.
     */
...
// {{{ --------------------------helpers----------------------------------------
     ...
     * @param {Boolean} down Whether the calculation was requested when the user scrolls down
     */
    ...
    replaceLiveRows : function(cursor, forceReplace, processRows)
    {
        ...
        // decide whether to prepend or append rows
...
Ext.extend(Ext.ux.grid.livegrid.Store, Ext.data.Store, {
    ...
    {
        // check whether the record.id can be found in this store
